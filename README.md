...
Stormwater (stormwater units/km²), septic system (septic units/km²) densities, and primary basin names were calculated using the Summarize Within tool in ArcGIS, based on 2021 Miami-Dade County datasets: the Stormwater Point dataset (Miami-Dade County Open Data Hub, 2015), the DOH Septic Systems dataset (Miami-Dade County Open Data Hub, 2016), and primary basin names ((Miami-Dade County Open Data Hub, 2014). Crop cover was derived from the 2021 National Land Cover Dataset (NLCD; Dewitz, 2023). Similarly, Natural land cover was extracted from the 2021 National Land Cover Dataset (NLCD; Dewitz, 2023) and was calculated as the sum of deciduous forest, evergreen forest, mixed forest, shrub/scrub, herbaceous cover, woody wetlands, and emergent herbaceous wetlands, expressed as a percentage of the total area. The distance to the salt line, the inland extent of saltwater intrusion, was calculated as the straight-line distance (in kilometers) from each sampling site to the nearest point along the saltwater interface in the Biscayne Aquifer, using USGS data (Prinos, 2019). The distance to the coast was similarly estimated as the shortest distance (in kilometers) to the NOAA Composite Shoreline (Office for Coastal Management, 2025).
